	...
	if(userList) {
		...
		userList.insertAdjacentHTML('beforeend', `<li>
			<a class="block relative" href="#">
				...
				<span class="absolute username">${user.username}</span>
			</a>
		</li>`);
		...
		chat.insertAdjacentHTML( 'beforeend', `<div class="message flex flex-row">
			...
			<div class="message-wrapper">
				<p class="message-header">
					<span class="username font-600">${user.username}</span>
...
// Retrieve username/password object from the login/signup page
...
// Log in either using the given username/password or the token from storage
